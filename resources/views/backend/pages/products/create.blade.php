...
@section('content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            <div class="btn-group">
                <a href="{{ route('roles.index') }}" class="btn btn-primary">All Product</a>
            </div>
        </div>
    </div>
    <!--end breadcrumb-->
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="number"
                                    ...
                                    @enderror"
                                    id="price" name="price" value="" placeholder="Product price">
                                @error('price')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="number"
                                    ...
                                    @enderror"
                                    id="quantity" name="quantity" value="" placeholder="Product quantity">
                                @error('quantity')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control @error('description') is-invalid
                                    @enderror"
                                    id="description" name="description" rows="3" placeholder="description"></textarea>
                                @error('description')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
